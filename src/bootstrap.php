...
$routerService->get('/turnoActual','TurnoActualController@get');
$routerService->put('/turnoActual','TurnoActualController@put');
$routerService->get('/misTurnos','TurnoActualController@getMisTurnos');
$routerService->put('/misTurnos','TurnoActualController@actualizarMisTurnos');
